    ...
    <footer className="mt-20" style={{ background: 'rgba(5,5,15,0.95)', borderTop: '1px solid rgba(99,102,241,0.15)' }}>
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-gray-500 text-xs">{t('footer.subtitle')}</div>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-5">
              {[t('footer.weibo'), t('footer.bilibili'), t('footer.wechat'), 'Discord'].map(s => (
          ...
          {/* Games */}
          <div>
            <h4 className="text-white font-bold text-sm mb-4 uppercase tracking-wider">{t('footer.games')}</h4>
          ...
          {/* Links */}
          <div>
            <h4 className="text-white font-bold text-sm mb-4 uppercase tracking-wider">{t('footer.about')}</h4>
            <ul className="space-y-2">
              {[t('footer.aboutPlatform'), t('footer.cooperation'), t('footer.media'), t('footer.terms'), t('footer.privacy'), t('footer.help'), t('footer.join')].map(l => (
                <li key={l}>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="text-gray-600 text-xs">{t('footer.copyright')}</div>
